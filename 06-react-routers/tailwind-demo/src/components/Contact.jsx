...
export default function Contact() {
  ...
  // The formData is passed automatically from the form Action
  const formSubmitHandler = async (formData) => {
    // Some form validation or submission logic here...
  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <form action={formSubmitHandler} className="mx-auto mt-16 max-w-xl sm:mt-20">
